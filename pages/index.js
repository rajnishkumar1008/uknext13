          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="more-new-inner pad13">
                ...
                <div className="cla-brn">
                  <Link href="/products/microsoft-dynamics-365/" className="btn btn-md btn-danger btn-custmm">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="figer-box">
                ...
                <div className="over-layer-cont">
                  ...
                  <Link href="/industries/microsoft-cloud-for-nonprofit/" className="boxshadow kallyas-button kallyas-button-nn">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="figer-box">
                ...
                <div className="over-layer-cont">
                  ...
                  <Link href="/industries/ecommerce/" className="boxshadow kallyas-button kallyas-button-nn">
                  ...
                  <div className="casestudys-slider-item">
                    <div className="profile mt-auto">
                      ...
                      <div className="case-button">
                        <Link href="/case-studies/nav2009R2-to-business-central/" className="btn btn-md btn-custom-1">
                ...
                <SwiperSlide>
                  <div className="casestudys-slider-item">
                    <div className="profile mt-auto">
                      ...
                      <div className="case-button">
                        <Link href="/case-studies/nav09-nav18-upgrade/" className="btn btn-md btn-custom-1">
                          Read More <span className="screen-reader-text">Details</span>
                        </Link>
                      </div>
                    </div>
                ...
                <SwiperSlide>
                  <div className="casestudys-slider-item">
                    <div className="profile mt-auto">
                      ...
                      <div className="case-button">
                        <Link href="/case-studies/nav-2016-support-services/" className="btn btn-md btn-custom-1">
                          Read More <span className="screen-reader-text">Details</span>
                        </Link>
                      </div>
                    </div>
